...
import (
	...
	pb "github.com/chernyshev/bchd/bchrpc/pb"
...
```
**More Examples**: [here](https://github.com/chernyshev/bchd/tree/master/bchrpc/documentation/client-usage-examples/nodejs-grpc)
