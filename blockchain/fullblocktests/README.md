...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/chernyshev/bchd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/chernyshev/bchd/blockchain/fullblocktests
```
