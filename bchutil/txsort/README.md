...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/chernyshev/bchd/btcutil/txsort)
...
```bash
$ go get -u github.com/chernyshev/bchd/btcutil/txsort
```
