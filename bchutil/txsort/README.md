...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/chernyshev/bchd/bchutil/txsort)
...
```bash
$ go get -u github.com/chernyshev/bchd/bchutil/txsort
```
