...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/chernyshev/bchd/peer)
...
```bash
$ go get -u github.com/chernyshev/bchd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/chernyshev/bchd/peer#example-package--NewOutboundPeer)  
