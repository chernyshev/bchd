...
[![Go Report Card](https://goreportcard.com/badge/github.com/chernyshev/bchd)](https://goreportcard.com/report/github.com/chernyshev/bchd)
[![ISC License](http://img.shields.io/badge/license-ISC-blue.svg)](http://copyfree.org)
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/chernyshev/bchd)
...
mkdir workspace
cd workspace
git clone https://github.com/chernyshev/bchd.git
cd bchd
...
See the [sample config file](https://github.com/chernyshev/bchd/blob/master/sample-bchd.conf) for an example of how to use it.
...
The documentation is a work-in-progress.  It is located in the [docs](https://github.com/chernyshev/bchd/tree/master/docs) folder.

## Contributing

Contributions are definitely welcome! Please read the contributing [guidelines](https://github.com/chernyshev/bchd/blob/master/docs/code_contribution_guidelines.md) before starting.
